#!/usr/bin/env python3
"""
Matthew Parker Heardle - Music Catalog Sync
...
DEEZER_ARTIST_ID = 1608538
YOUTUBE_CHANNEL = "https://www.youtube.com/channel/UC-Rz3QbsVAfqIyVtIam994Q"
...
# Track titles to never add (case-insensitive substring).
#
# Instrumentals are excluded because the backing track is the same recording as
# the vocal version already in the list, so a 32-second clip of one is hard to
# tell from the other -- that makes a round unfair rather than hard.
TITLE_SKIP = ("(instrumental)",)
...
def title_keys(video_title):
    ...
    "Dream Label Group - Matthew Parker - Kaleidoscope (Official Video)".
