...
/**
 * Whole days elapsed between `startISO` and now, measured in Eastern Time.
 *
 * Eastern Time is the reference zone for the daily rollover, so both endpoints
 ...
 */
export function daysSinceStartInET(startISO) {
